        ...
        $(function(){
            ...
            $('#dg').datagrid({
                ...
                // columns:[[
                    ...
                    {field:'last_editors',title:'最後修改者',width:120 ,halign:'center'},
        ...
        <form id="fm" method="post" novalidate>
        	<table>
        		...
        		<tr class="row">
        			...
        			<td class="row_content">
		                <input name="date" style="width:400px;" class="easyui-datebox">
					</td>
        		</tr>
                <tr class="row">
    	...
    	<div style="padding:10px 20px">
	        ...
	        <table>
                ...
                <tr>						            
                    <td class="row_title"><label>日期：</label></td>
                    <td class="row_content">						           
                        <input name="date" style="width:175px;" class="easyui-validatebox textbox">
                    </td>
                </tr>  
