        ...
        $(function(){
            $('#dg').datagrid({
                ...
                frozenColumns:[[
                    ...
                    {field:'start',title:'班次編號',width:100,halign:'center'},
                    {field:'end',title:'購票姓名',width:120,halign:'center',align:'center'},
                    {field:'end',title:'身分證字號',width:150,halign:'center',align:'center'},
                    {field:'end',title:'電話',width:150,halign:'center',align:'center'},
                ]],
                columns:[[
                    {field:'onePrice',title:'票種',width:100,halign:'center',align:"center",formatter:formatPicture},
                    {field:'halfFare',title:'張數',width:100,halign:'center'},
                    {field:'backAndForth',title:'座位',width:150,halign:'center',align:"center"},
                    {field:'last_edit',title:'取票代碼',width:150 ,halign:'center'},
                    {field:'last_edit',title:'總金額',width:100 ,halign:'center'},
                    {field:'last_editors',title:'購買時間',width:150 ,halign:'center'},
...
<!-- 功能按鈕 -->
    <div id="toolbar">
  	    ...
  	    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="destroyUser()">取消</a>
